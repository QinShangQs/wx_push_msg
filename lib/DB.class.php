...
class DB {
	...
	private function connect() {
		...
		if (! $this->link) {
			...
			echo date('Ymd H:i:s').' 数据库连接错误：'."\n";
			echo date('Ymd H:i:s').' 错误编号' . mysql_errno () . "\n";
			echo date('Ymd H:i:s').' 错误内容' . mysql_error () . "\n";
			exit ();
		}
	}
